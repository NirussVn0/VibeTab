...
export const useCommandPaletteStore = defineStore('commandPalette', () => {
  ...
  // const settingsStore = useSettingsStore() // Future use
  ...
  const staticCommands: Command[] = [
    {
      ...
      category: 'search',
      keywords: ['google', 'web', 'find'],
      action: (query) => { window.open(`https://google.com/search?q=${encodeURIComponent(query || '')}`, '_blank') }
    },
    {
      id: 'search-ai',
      title: 'Ask AI',
      ...
      category: 'search',
      keywords: ['ai', 'gpt', 'chat', 'bot'],
      action: (query) => { window.open(`https://chatgpt.com/?q=${encodeURIComponent(query || '')}`, '_blank') }
    },
    {
      id: 'open-settings',
      title: 'Open Settings',
      description: 'Configure VibeTab',
      category: 'settings',
    ...
    },
    {
      ...
      description: 'Rearrange or add widgets',
      category: 'actions',
      keywords: ['edit', 'layout', 'grid', 'move'],
      action: () => { uiStore.toggleEditMode() }
    },
    {
      id: 'toggle-theme',
      title: 'Switch Theme',
